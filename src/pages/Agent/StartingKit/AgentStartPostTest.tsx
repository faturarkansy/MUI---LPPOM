    ...
    <div>
      ...
      <div className="mt-6 text-left">
        <p className="font-medium text-sm mb-1">
          Pass the Passing Grade to complete the Post Test
        </p>
        <p className="font-semibold text-md mb-6">Passing Grade : 80</p>
        ...
        <div className="flex justify-start gap-4">
          ...
          <button
            onClick={() => navigate("/agent/post-test")}
            className="bg-black text-white px-6 py-2 rounded-md hover:bg-gray-800"
          >
            Start Test
          </button>
...
export default AgentStartPostTest;
