...
const AgentActivities = () => {
  ...
  return (
    <div>
      ...
      <div className="pt-3 pb-2 flex justify-end lg:justify-between items-center">
        ...
        <button
          ...
          className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-bold border-2 border-[#7EC34B] rounded-lg bg-white text-[#7EC34B] hover:bg-gray-200 hover:text-[#7EC34B] focus:outline-hidden focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none cursor-pointer"
        >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm">
                    <div className="relative">
                      <button
                        ...
                        className={`p-2 bg-gray-400 rounded-lg ${openMenuId ? "rotate-90" : ""
                          }`}
                      >
                        <ChevronDownIcon />
                      </button>
